...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(scaffoldBackgroundColor: Colors.tealAccent,primarySwatch: Colors.blue, accentColor: Colors.purple),
      home: MyHomePage(),
    );
  }
}
          ...
          Container(
            ...
            decoration: BoxDecoration(
                ...
                border: BorderDirectional(
                  top: BorderSide(color: Colors.tealAccent, width: 2),
